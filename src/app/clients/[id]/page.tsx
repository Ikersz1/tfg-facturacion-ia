...
export default async function ClientDetailPage({ params }: PageProps) {
  ...
  const invoicesLink = buildInvoicesListUrl({ client_id: id });
  ...
  return (
    <div className="flex w-full flex-1 flex-col">
      ...
      <div className="flex flex-wrap gap-2">
        <Link
          href={invoicesLink}
          className="inline-flex h-10 items-center rounded-lg border border-zinc-300 bg-white px-4 text-sm font-medium text-zinc-800 shadow-sm hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800"
        >
          Ver en Facturas (filtrado)
        </Link>
        <Link
